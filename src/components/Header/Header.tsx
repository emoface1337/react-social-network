...
import { AppBar, Box, Grid, IconButton, makeStyles, Theme, Toolbar, Typography } from '@material-ui/core'
import ExitToAppIcon from '@material-ui/icons/ExitToApp'
import { RootState } from '../../ducks'
import { logoutThunk } from '../../ducks/auth'
                    ...
                    </Typography>
                    {
                        isAuth
                            ...
                            <Box className={classes.loginBlock}>
                                ...
                                <IconButton color="secondary" onClick={() => dispatch(logoutThunk())}
